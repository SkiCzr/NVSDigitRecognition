...
Screen_1ViewBase::Screen_1ViewBase()
{
    ...
    EV_Text.setRotation(touchgfx::TEXT_ROTATE_90);
    ...
    ER_Text.setRotation(touchgfx::TEXT_ROTATE_90);
    ...
    Bar_Text_0_10.setVisible(false);
    add(Bar_Text_0_10);
